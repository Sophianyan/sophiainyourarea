    ...
    if (onFinale) {
        ...
        for (let i = 0; i < winnerQueen.trackRecord.length; i++) {
            ...
            if (placement.innerHTML == "WIN") {
                ...
                placement.setAttribute("style", "font-weight: bold; background-color: darkred;");
            }
            else if (placement.innerHTML == "ELIM") {
...
let dame = new Queen("La Grande Dame", 11, 10, 8, 12, 8, 11, 8, "GrandeDame");
...
let drfr = [elips, kam, bigbertha, briochee, dame, kahena, lolita, lova, paloma, soa];
//DRAG RACE FRANCE 2
...
let allQueens = [
    ...
    elips, kam, bigbertha, briochee, dame, kahena, lolita, lova, paloma, soa,
