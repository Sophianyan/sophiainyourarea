...
class Rumix {
    generateDescription() {
        ...
        description.innerHTML = "Today's maxi-challenge is... the Rumix! The Queens will make a verse and a coreography for " + desc1[randomNumber(0, 17)];
    }
    rankPerformances() {
        for (let i = 0; i < currentCast.length; i++)
...
let naysha = new Queen("Naysha Lopez", 4, 4, 4, 4, 3, 6, 4, "Naysha");
...
let dres3 = [bestiah, chanel, clover, chuchi, hornella, maria, kellyRoller, pakita, pink, pitita, vania, visa, macarena];
//DRAG RACE ITALIA
...
let allQueens = [
    ...
    astrud, betty, formelda, hoso, jadejolie, koco, lazavaleta, merrie, saint, sigourney,
