...
function designChallenge() {
    ...
    if (currentCast.length == 6 && makeoverCounter == false && team == false && currentCast != firstCast && currentCast != secondCast) {
        episodeChallenges.push("Mak-Ver");
...
let ukvstw2 = [arantxa, choriza, gothy, hannah, jonbers, keta, marinaSummers, mayhem, scarlet, tia, lagrandedame];
...
let lagrandedame = new Queen("La Grande Dame", 11, 10, 8, 12, 8, 11, 8, "GrandeDame");
...
let drfr = [elips, kam, bigbertha, briochee, lagrandedame, kahena, lolita, lova, paloma, soa];
//DRAG RACE FRANCE 2
...
let allQueens = [
    ...
    elips, kam, bigbertha, briochee, lagrandedame, kahena, lolita, lova, paloma, soa,
